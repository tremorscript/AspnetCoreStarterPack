...
using Northwind.Core.Domain.Discounts;
using Northwind.Core.Domain.Localization;
using Northwind.Core.Domain.Security;
...
public partial class Category : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported<DiscountCategoryMapping>, ISoftDeletedEntity
{
    ...
    /// <inheritdoc/>
    public new int Id { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
}